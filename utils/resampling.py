...
def resampling(source_file, target_file, scale=2.0):
    """
    影像重采样
...
if __name__ == "__main__":
    source_file = '/mnt/win/data/AISample/IMAGE/LM11370341974144AAA04/LM1137034007414410_B4.tif'
    target_file = '/mnt/win/data/AISample/IMAGE/b4_30.tif'
    source_file='/mnt/win/data/AISample/IMAGE/LM21370331977245GDS03_IRRG.TIF'
    target_file = '/mnt/win/data/AISample/IMAGE/b654_30.tif'
    resampling(source_file, target_file, scale=2.0)
#     target_file = '/mnt/win/data/AISample/IMAGE/b4_120.tif'
