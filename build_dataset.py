...
import json
from sepolicy.templates.spec import define_relabel_files_begin
...
#                 yoff_list.append(yoff)
    ...
    return wgs_bbox_list,rnum_tile,cnum_tile
...
# bj_2001: LT51230322001323BJC00  LT51230332001323BJC00
    for region in region_dict.keys():
        ...
        wgs_bbox_list, rnum, cnum = gen_tile_bbox(region)
        ...
        for year in year_list:
            ...
            gtfile = os.path.join(gt_path, images_key + '_' + str(year) + '.tif')
            tiling_raster(gtfile, wgs_bbox_list, gt_tile_path, 1, 'label')
            
# bj20010001_LC*1230322014098LGN00.tif    
...
#             region_tif = region_dict[region]['region_tif']
#             image_file = os.path.join(region_tif_path, region_tif)
#             print('the image is :', region_file)
#             dataset = gdal.Open(region_file)
#             if dataset is None:
#                 print("Failed to open file: " + region_file)
